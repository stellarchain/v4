    ...
    <aside className="sidebar-container w-[260px] min-h-screen flex flex-col sticky top-0 h-screen shrink-0 bg-[var(--bg-tertiary)] border-r border-[var(--border-subtle)]">
      ...
      <div className="p-6 pb-4">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 bg-[var(--bg-primary)] border border-[var(--border-subtle)] rounded-xl flex items-center justify-center shadow-sm">
      ...
      <div className="p-4 space-y-1">
        <button className="flex items-center gap-3 px-3 py-2.5 w-full text-[var(--text-secondary)] hover:text-[var(--primary)] rounded-xl hover:bg-[var(--bg-tertiary)] transition-all duration-200 text-[13px]">
          <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Network Status */}
        <div className="mt-4 px-3 py-3 bg-[var(--bg-tertiary)] rounded-xl border border-[var(--border-subtle)]">
