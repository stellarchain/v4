                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="col-span-1 flex items-center justify-center">
                                    <span className={`text-xs font-semibold ${index < 3
                                        ? 'text-[var(--primary)]'
                                        : 'text-[var(--text-muted)]'
                                        }`}>
                                        {index + 1}
                                ...
                                <div className="col-span-5 flex items-center min-w-0">
                                    <div className="min-w-0 flex-1">
                                        <div className="flex items-center gap-2">
                                            <span className="text-[var(--text-primary)] font-medium text-sm truncate group-hover:text-[var(--primary)] transition-colors">
                                                {account.name}
                                            </span>
                                            {isVerified && (
                                                <svg className="w-3.5 h-3.5 text-[var(--primary)] shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div className="col-span-3 flex items-center justify-end">
                                    <span className="text-[var(--text-primary)] font-medium text-sm font-mono">
                                        {balanceTag}
                                    </span>
                                </div>
                                ...
                                <div className="col-span-2 flex items-center justify-end">
                                    {percentTag && (
                                        <span className="px-2 py-0.5 rounded-lg text-xs font-medium bg-[var(--bg-tertiary)] text-[var(--text-muted)]">
                                            {percentTag}
                                        </span>
                                    )}
                                </div>
                                ...
                                <div className="col-span-1 flex items-center justify-center">
                                    {isVerified ? (
                                        <span className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-[var(--primary)]/10 text-[var(--primary)]">
                                            Known
                                        </span>
                                    ) : (
                                        <span className="w-1.5 h-1.5 rounded-full bg-[var(--text-muted)]/30"></span>
                                    )}
                                </div>
                            </Link>
                        );
