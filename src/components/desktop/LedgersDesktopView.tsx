          ...
          <div className="flex flex-wrap items-start justify-between gap-5">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <div className="p-3 rounded-xl bg-emerald-50/70 border border-emerald-100 min-w-[90px]">
                ...
                <div className="text-lg font-bold text-emerald-600">{stats.totalTxs.toLocaleString()}</div>
              </div>
              <div className="p-3 rounded-xl bg-sky-50/70 border border-sky-100 min-w-[90px]">
                <div className="text-[9px] font-bold text-sky-600/60 uppercase tracking-widest mb-1">Operations</div>
                <div className="text-lg font-bold text-sky-600">{stats.totalOps.toLocaleString()}</div>
              </div>
              <div className="p-3 rounded-xl bg-violet-50/70 border border-violet-100 min-w-[90px]">
                <div className="text-[9px] font-bold text-violet-600/60 uppercase tracking-widest mb-1">Avg Close</div>
                <div className="text-lg font-bold text-violet-600">{stats.avgCloseTime.toFixed(1)}s</div>
              </div>
              <div className="p-3 rounded-xl bg-amber-50/70 border border-amber-100 min-w-[110px]">
                <div className="text-[9px] font-bold text-amber-600/60 uppercase tracking-widest mb-1">Total Coins</div>
                <div className="text-lg font-bold text-amber-600">{formatCompact(stats.totalCoins)}</div>
              </div>
            </div>
          </div>
        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-2.5 px-4 text-center">
                          <span className="inline-flex items-center px-2 py-0.5 rounded bg-sky-50 border border-sky-100 text-[10px] font-bold text-sky-600">
