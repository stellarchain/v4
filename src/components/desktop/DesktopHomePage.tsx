        ...
        <div className="min-h-screen bg-[var(--bg-primary)]">
            ...
            <section className="relative pt-16 pb-20 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-[-10%] left-[10%] w-[500px] h-[500px] bg-sky-100 dark:bg-sky-900/20 rounded-full filter blur-3xl opacity-60 dark:opacity-30 animate-pulse"></div>
                    <div className="absolute top-[10%] right-[15%] w-[400px] h-[400px] bg-indigo-100 dark:bg-indigo-900/20 rounded-full filter blur-3xl opacity-60 dark:opacity-30"></div>
                </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                        <Link href={`/ledger/${liveStats.ledger_count}`} className="bg-[var(--bg-secondary)] rounded-xl p-4 border border-[var(--border-subtle)] hover:border-blue-200 transition-all group">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-9 h-9 bg-blue-50 dark:bg-blue-900/40 rounded-lg flex items-center justify-center text-blue-700 group-hover:bg-blue-500 group-hover:text-white transition-colors">
                        ...
                        <div className="bg-[var(--bg-secondary)] rounded-xl p-4 border border-[var(--border-subtle)]">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-9 h-9 bg-amber-50 dark:bg-amber-900/40 rounded-lg flex items-center justify-center text-amber-700">
                        ...
                        <div className="bg-[var(--bg-secondary)] rounded-xl p-4 border border-[var(--border-subtle)]">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-9 h-9 bg-violet-50 dark:bg-violet-900/40 rounded-lg flex items-center justify-center text-violet-700">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div className="bg-[var(--bg-secondary)] rounded-xl p-4 border border-[var(--border-subtle)]">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-9 h-9 bg-rose-50 dark:bg-rose-900/40 rounded-lg flex items-center justify-center text-rose-700">
                        ...
                        <div className="bg-[var(--bg-secondary)] rounded-xl p-4 border border-[var(--border-subtle)]">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-9 h-9 bg-indigo-50 dark:bg-indigo-900/40 rounded-lg flex items-center justify-center text-indigo-700">
                        ...
                        <div className="bg-[var(--bg-secondary)] rounded-xl p-4 border border-[var(--border-subtle)]">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-9 h-9 bg-emerald-50 dark:bg-emerald-900/40 rounded-lg flex items-center justify-center text-emerald-700">
                                ...
                                <tbody className="divide-y divide-[var(--border-subtle)]">
                                    {filteredOperations.length === 0 ? (
                                        ...
                                        filteredOperations.slice(0, 15).map((op) => {
                                            ...
                                            // Get type colors
                                            const getTypeColors = () => {
                                                if (op.type === 'payment' || op.type === 'create_account') return 'bg-emerald-50 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800/50';
                                                if (op.type === 'path_payment_strict_send' || op.type === 'path_payment_strict_receive') return 'bg-violet-50 dark:bg-violet-900/40 text-violet-700 dark:text-violet-400 border-violet-200 dark:border-violet-800/50';
                                                if (['manage_sell_offer', 'manage_buy_offer', 'create_passive_sell_offer'].includes(op.type)) return 'bg-indigo-50 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800/50';
                                                if (op.type === 'invoke_host_function') return 'bg-amber-50 dark:bg-amber-900/40 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-800/50';
                                                if (op.type === 'change_trust') return 'bg-teal-50 dark:bg-teal-900/40 text-teal-700 dark:text-teal-400 border-teal-200 dark:border-teal-800/50';
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="py-2 px-1 text-center">
                                                        <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-emerald-50 dark:bg-emerald-900/40 text-emerald-700">
