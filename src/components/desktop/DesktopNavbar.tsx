                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <Link href="/" className="flex items-center">
                            <Image
                                ...
                                width={180}
                                height={40}
                                className={`h-9 w-auto ${theme === 'dark' ? 'invert' : 'brightness-0'}`}
                                priority
                            />
                        </Link>
                            ...
                            {favorites.length > 0 && (
                                <div className="relative" ref={favoritesRef}>
                                    ...
                                    >
                                        ...
                                        <span>Watchlist</span>
                                        <span className="bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-400 text-xs font-bold px-1.5 py-0.5 rounded-full">
                                            {favorites.length}
                                        </span>
                                        {favorites.length > 1 && (
                                            <svg
