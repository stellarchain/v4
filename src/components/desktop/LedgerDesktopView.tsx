            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <section className="lg:col-span-5 rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] shadow-sm">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="p-3 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-primary)]/70">
                    <div className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest mb-1">Total Coins</div>
                    <div className="text-lg font-bold text-[var(--text-primary)]">{formatXLM(ledger.total_coins)} <span className="text-xs font-medium text-[var(--text-muted)]">XLM</span></div>
                  </div>
                  <div className="p-3 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-primary)]/70">
                    <div className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest mb-1">Fee Pool</div>
                    <div className="text-lg font-bold text-[var(--text-primary)]">{formatXLM(ledger.fee_pool)} <span className="text-xs font-medium text-[var(--text-muted)]">XLM</span></div>
                  </div>
                </div>
              </section>
            </div>
