        ...
        <div className="flex gap-2 items-stretch px-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full h-10 pl-9 pr-3 bg-white border border-slate-200 rounded-xl text-sm font-medium placeholder-slate-400 text-slate-900 focus:ring-2 focus:ring-slate-900 focus:border-transparent focus:outline-none transition-all"
            />
          </div>
