        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <div className="flex items-center gap-2">
                        <h1 className="text-xl font-semibold text-white tracking-tight">Statistics</h1>
                        <span className="w-1.5 h-1.5 bg-[#BFF549] rounded-full animate-pulse-soft" />
                    </div>
                    <p className="text-[#555] text-xs">Real-time Stellar network metrics and market data</p>
                </div>
            </div>
            ...
            <section>
                <div className="flex items-center gap-2 mb-4">
                    <div className="w-1 h-4 bg-[#BFF549] rounded-full" />
