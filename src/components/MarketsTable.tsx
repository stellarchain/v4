      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full bg-[var(--bg-tertiary)] text-[var(--text-primary)] pl-12 pr-4 py-3 rounded-xl focus:ring-2 focus:ring-[var(--primary)]/20 transition-colors shadow-inner text-sm"
          />
        </div>
