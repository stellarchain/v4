...
function InfoTooltip({ label, content, direction = 'top' }: { label: React.ReactNode; content: string; direction?: 'top' | 'bottom' }) {
  ...
  return (
    <div className="relative inline-flex items-center">
      ...
      {isOpen && (
        <div
          className={`absolute left-1/2 -translate-x-1/2 w-48 p-2.5 bg-gray-900 text-white text-[10px] leading-relaxed rounded-xl shadow-xl z-50 animate-in fade-in zoom-in-95 duration-200 ${direction === 'top'
              ? 'bottom-full mb-2'
              : 'top-full mt-2'
            }`}
        >
          {content}
          <div
            className={`absolute left-1/2 -translate-x-1/2 border-8 border-transparent ${direction === 'top'
