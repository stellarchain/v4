      ...
      <div className="space-y-3">
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-[var(--bg-tertiary)] border border-[var(--border-subtle)] rounded-lg py-3 px-4 pr-16 text-[var(--text-primary)] font-mono text-[15px] focus:outline-none focus:border-[var(--primary)] transition-colors"
            placeholder="0"
          />
