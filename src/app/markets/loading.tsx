      ...
      <div className="hidden md:block min-h-screen bg-slate-50">
        <div className="mx-auto max-w-[1400px] p-6 lg:p-8">
            ...
            <div className="flex flex-wrap items-start justify-between gap-5">
              ...
              <div className="flex gap-3">
                <div className="p-3 rounded-xl bg-sky-50/70 border border-sky-100 min-w-[110px]">
                  ...
                  <div className="h-6 w-24 bg-sky-300 rounded animate-pulse" />
                </div>
          ...
          <div className="rounded-2xl border border-slate-200/60 bg-white shadow-sm overflow-hidden">
            {/* Header */}
            <div className="grid grid-cols-10 gap-4 px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <div className="w-8" />
              <div className="h-4 w-8 bg-slate-200 rounded animate-pulse" />
              <div className="h-4 w-16 bg-slate-200 rounded animate-pulse col-span-2" />
            ...
            {/* Rows */}
            {[...Array(12)].map((_, i) => (
              <div key={i} className="grid grid-cols-10 gap-4 px-6 py-4 border-b border-slate-100 last:border-b-0 items-center">
      ...
      <div className="block md:hidden bg-slate-50 min-h-screen pb-24">
        <div className="px-4 py-4 space-y-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-sky-100 animate-pulse rounded-xl" />
            <div>
