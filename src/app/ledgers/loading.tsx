            ...
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="h-6 w-28 bg-slate-200 dark:bg-gray-800 rounded animate-pulse mb-1" />
              ...
              <div className="flex gap-3">
                <div className="p-3 rounded-xl bg-sky-50/70 dark:bg-sky-900/20 border border-sky-100 dark:border-sky-800/30 min-w-[110px]">
                  <div className="h-3 w-20 bg-sky-200 dark:bg-sky-800/50 rounded animate-pulse mb-2" />
                  <div className="h-6 w-24 bg-sky-200 dark:bg-sky-800/50 rounded animate-pulse" />
                </div>
      ...
      <div className="block md:hidden bg-slate-50 dark:bg-[#0a0f1a] min-h-screen pb-24">
        <div className="px-4 py-4 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="h-5 w-24 bg-slate-200 dark:bg-gray-800 rounded animate-pulse mb-1" />
              <div className="h-4 w-48 bg-slate-200 dark:bg-gray-800 animate-pulse rounded" />
            </div>
          </div>
            ...
            <div key={i} className="bg-white dark:bg-[#111827] rounded-xl p-4 shadow-sm border border-slate-200 dark:border-gray-800">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="h-5 w-20 bg-slate-200 dark:bg-gray-800 animate-pulse rounded mb-1" />
                    <div className="h-3 w-24 bg-slate-200 dark:bg-gray-800 animate-pulse rounded" />
                  </div>
                </div>
                <div className="text-right">
                  <div className="h-4 w-20 bg-slate-200 dark:bg-gray-800 animate-pulse rounded mb-1" />
                  <div className="h-3 w-16 bg-slate-200 dark:bg-gray-800 animate-pulse rounded" />
                </div>
              </div>
              <div className="flex items-center justify-between text-sm pt-3 border-t border-slate-100 dark:border-gray-800">
                <div className="h-3 w-16 bg-slate-200 dark:bg-gray-800 animate-pulse rounded" />
