        ...
        <div className="mx-auto max-w-[1400px] p-6 lg:p-8">
          ...
          <div className="flex gap-4 items-center mb-5">
            ...
            <div className="flex gap-2">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="h-10 w-24 bg-white border border-slate-200 rounded-xl animate-pulse" />
              ))}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200/60 bg-white shadow-sm overflow-hidden">
            ...
            <div className="grid grid-cols-6 gap-4 px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <div className="h-4 w-20 bg-slate-200 rounded animate-pulse col-span-2" />
            ...
            {/* Rows */}
            {[...Array(10)].map((_, i) => (
              <div key={i} className="grid grid-cols-6 gap-4 px-6 py-4 border-b border-slate-100 last:border-b-0 items-center">
          ...
          {[...Array(6)].map((_, i) => (
            <div key={i} className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
              ...
              <div className="flex gap-2 mb-3">
                <div className="h-5 w-16 bg-sky-100 animate-pulse rounded-lg" />
                <div className="h-5 w-20 bg-slate-100 animate-pulse rounded-lg" />
              </div>
