    ...
    <>
        ...
        <div className="mx-auto max-w-[1400px] p-6 lg:p-8">
            ...
            <div className="flex flex-wrap items-start justify-between gap-5">
              ...
              <div className="flex gap-2">
                {['1D', '7D', '30D', '1Y'].map((_, i) => (
                  <div key={i} className={`h-9 w-12 rounded-lg animate-pulse ${i === 0 ? 'bg-sky-100' : 'bg-slate-100'}`} />
                ))}
              </div>
            </div>
          </div>
            ...
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-8 h-8 bg-sky-100 rounded-lg animate-pulse" />
                  <div className="h-3 w-20 bg-slate-200 rounded animate-pulse" />
                </div>
                <div className="h-8 w-28 bg-slate-200 rounded animate-pulse mb-1" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-5">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm">
                ...
                <div className="h-20 bg-slate-100 rounded-xl animate-pulse mb-3" />
          ...
          <div className="bg-white rounded-2xl border border-slate-200/60 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className={`h-8 w-16 rounded-lg animate-pulse ${i === 0 ? 'bg-sky-100' : 'bg-slate-100'}`} />
                ))}
              </div>
            </div>
      ...
      <div className="block md:hidden bg-slate-50 min-h-screen pb-24">
        <div className="px-4 py-4 space-y-4">
          ...
          <div className="flex gap-2">
            {['1D', '7D', '30D', '1Y'].map((_, i) => (
              <div key={i} className={`h-8 w-12 rounded-lg animate-pulse ${i === 0 ? 'bg-sky-100' : 'bg-white border border-slate-200'}`} />
            ))}
          </div>
            ...
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-6 h-6 bg-sky-100 rounded-lg animate-pulse" />
                  <div className="h-3 w-16 bg-slate-200 rounded animate-pulse" />
                </div>
                <div className="h-6 w-20 bg-slate-200 rounded animate-pulse mb-1" />
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-1">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="h-6 w-10 bg-slate-100 rounded animate-pulse" />
                ))}
              </div>
            </div>
          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
              ...
              <div className="flex justify-between">
                <div>
                  <div className="h-3 w-10 bg-slate-200 rounded animate-pulse mb-1" />
