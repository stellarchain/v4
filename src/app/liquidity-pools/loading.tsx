      ...
      <div className="hidden md:block min-h-screen bg-[var(--bg-primary)]">
        <div className="mx-auto max-w-[1400px] p-6 lg:p-8">
          ...
          <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] shadow-sm overflow-hidden">
            {/* Header */}
            <div className="grid grid-cols-7 gap-4 px-6 py-4 border-b border-[var(--border-subtle)] bg-[var(--bg-primary)]/50">
            ...
            {/* Rows */}
            {[...Array(10)].map((_, i) => (
              <div key={i} className="grid grid-cols-7 gap-4 px-6 py-4 border-b border-[var(--border-subtle)] last:border-b-0 items-center">
