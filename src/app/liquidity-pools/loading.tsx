      ...
      <div className="hidden md:block min-h-screen bg-[var(--bg-primary)]">
        <div className="mx-auto max-w-[1400px] p-4 lg:p-4">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="flex gap-3">
                <div className="p-3 rounded-xl bg-[var(--info-muted)] border border-[var(--info)]/20 min-w-[110px]">
                  ...
                  <div className="h-6 w-20 bg-[var(--info-muted)] rounded animate-pulse" />
                </div>
          ...
          <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] shadow-sm overflow-hidden">
            {/* Header */}
            <div className="grid grid-cols-7 gap-4 px-4 py-4 border-b border-[var(--border-subtle)] bg-[var(--bg-primary)]/50">
              <div className="h-4 w-12 bg-[var(--border-default)] rounded animate-pulse col-span-2" />
            ...
            {/* Rows */}
            {[...Array(10)].map((_, i) => (
              <div key={i} className="grid grid-cols-7 gap-4 px-4 py-4 border-b border-[var(--border-subtle)] last:border-b-0 items-center">
                <div className="flex items-center gap-3 col-span-2">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 bg-[var(--border-default)] rounded-full animate-pulse" />
                    <div className="w-8 h-8 bg-[var(--border-default)] rounded-full animate-pulse" />
                  </div>
                  <div>
      ...
      <div className="block md:hidden bg-[var(--bg-primary)] min-h-screen pb-24">
        <div className="px-4 py-4 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="h-5 w-28 bg-[var(--border-default)] rounded animate-pulse mb-1" />
              <div className="h-4 w-44 bg-[var(--border-default)] animate-pulse rounded" />
            </div>
          </div>
          ...
          {[...Array(6)].map((_, i) => (
            <div key={i} className="bg-[var(--bg-secondary)] rounded-xl p-4 shadow-sm border border-[var(--border-default)]">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 bg-[var(--border-default)] animate-pulse rounded-full" />
                    <div className="w-8 h-8 bg-[var(--border-default)] animate-pulse rounded-full" />
                  </div>
                  <div>
                    <div className="h-4 w-20 bg-[var(--border-default)] animate-pulse rounded mb-1" />
                    <div className="h-3 w-12 bg-[var(--border-default)] animate-pulse rounded" />
                  </div>
                </div>
                <div className="h-6 w-16 bg-[var(--info-muted)] animate-pulse rounded-lg" />
              </div>
              <div className="grid grid-cols-2 gap-3 pt-3 border-t border-[var(--border-subtle)]">
                <div>
                  <div className="h-3 w-12 bg-[var(--border-default)] animate-pulse rounded mb-1" />
                  <div className="h-4 w-20 bg-[var(--border-default)] animate-pulse rounded" />
                </div>
                <div>
                  <div className="h-3 w-12 bg-[var(--border-default)] animate-pulse rounded mb-1" />
                  <div className="h-4 w-20 bg-[var(--border-default)] animate-pulse rounded" />
