    ...
    <>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className="h-5 w-16 bg-emerald-100 dark:bg-emerald-900/30 rounded animate-pulse" />
                  </div>
                  <div className="h-6 w-48 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                </div>
              </div>

              {/* Right: Quick Stats */}
              <div className="flex gap-3">
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#0a0f1a] border border-slate-100 dark:border-gray-800 min-w-[100px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-5">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-6 border-b border-slate-200 dark:border-gray-800 pb-3">
                <div className="h-4 w-20 bg-sky-200 dark:bg-sky-800/50 rounded animate-pulse" />
              ...
              <div className="space-y-3">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="bg-white dark:bg-[#111827] rounded-xl border border-slate-200 dark:border-gray-800/60 shadow-sm p-4">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-xl bg-slate-200 dark:bg-gray-800 animate-pulse" />
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <div className="h-5 w-12 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                          <div className="h-4 w-24 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                        </div>
                        <div className="h-3 w-40 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                      </div>
                    </div>
                    <div className="bg-slate-50 dark:bg-[#0a0f1a] rounded-xl p-3 space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="h-3 w-12 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                        <div className="h-4 w-32 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="h-3 w-8 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                        <div className="h-4 w-32 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                      </div>
                      <div className="flex items-center justify-between pt-2 border-t border-slate-200 dark:border-gray-800">
                        ...
                        <div className="h-5 w-28 bg-slate-200 dark:bg-gray-800 rounded animate-pulse" />
                      </div>
                    </div>
                  </div>
                ))}
      ...
      <div className="block md:hidden min-h-screen bg-slate-50 dark:bg-[#0a0f1a] pb-24">
        ...
        <header className="sticky top-0 z-10 bg-white dark:bg-[#111827] border-b border-slate-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between">
          ...
          <div className="h-9 w-24 rounded-full bg-slate-200 dark:bg-gray-800 animate-pulse" />
        </header>
        ...
        <main className="px-4 pt-4">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4">
            ...
            <div className="h-5 w-20 rounded-full bg-emerald-100 dark:bg-emerald-900/30 animate-pulse" />
          ...
          <div className="bg-white dark:bg-[#111827] rounded-2xl shadow-sm border border-slate-200 dark:border-gray-800 p-4 mb-4">
            <div className="flex justify-between items-start mb-4">
              <div>
                <div className="h-3 w-20 rounded bg-slate-200 dark:bg-gray-800 animate-pulse mb-2" />
                <div className="h-5 w-28 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
              </div>
            ...
            {/* Summary Card */}
            <div className="bg-slate-50 dark:bg-[#0a0f1a] border border-slate-200 dark:border-gray-800 rounded-2xl p-4 space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-gray-800 animate-pulse" />
                  <div className="h-3 w-12 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
                </div>
                <div className="text-right">
                  <div className="h-4 w-24 rounded bg-slate-200 dark:bg-gray-800 animate-pulse mb-1" />
                  <div className="h-3 w-10 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
                </div>
              </div>
              <div className="flex justify-center">
                <div className="w-6 h-6 rounded-full bg-slate-200 dark:bg-gray-800 animate-pulse" />
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-gray-800 animate-pulse" />
            ...
            <div className="mt-4 pt-4 border-t border-slate-200 dark:border-gray-800">
              <div className="flex items-center justify-between">
                ...
                <div className="h-3 w-24 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4 border-b border-slate-200 dark:border-gray-800 pb-3 mb-4">
            {['Operations', 'Effects', 'Details'].map((tab, i) => (
              <div key={tab} className={`h-4 rounded animate-pulse ${i === 0 ? 'w-20 bg-sky-200 dark:bg-sky-800/50' : 'w-16 bg-slate-200 dark:bg-gray-800'}`} />
            ))}
          </div>
          ...
          <div className="space-y-3">
            {[1, 2].map((i) => (
              <div key={i} className="bg-white dark:bg-[#111827] rounded-2xl shadow-sm border border-slate-200 dark:border-gray-800 p-4">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-slate-200 dark:bg-gray-800 animate-pulse" />
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <div className="h-5 w-12 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
                      <div className="h-4 w-20 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
                    </div>
                    <div className="h-3 w-32 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
                  </div>
                </div>
                <div className="bg-slate-50 dark:bg-[#0a0f1a] rounded-xl p-3 space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="h-3 w-10 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
                    <div className="h-3 w-28 rounded bg-slate-200 dark:bg-gray-800 animate-pulse" />
                  </div>
                  <div className="flex items-center justify-between">
