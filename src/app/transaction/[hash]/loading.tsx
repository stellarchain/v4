              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className="h-5 w-16 bg-emerald-100 rounded animate-pulse" />
                  </div>
      ...
      <div className="block md:hidden min-h-screen bg-slate-50 pb-24">
        ...
        <main className="px-4 pt-4">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4">
            ...
            <div className="h-5 w-20 rounded-full bg-emerald-100 animate-pulse" />
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 mb-4">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-right">
                <div className="h-3 w-12 rounded bg-slate-200 animate-pulse mb-2" />
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="h-4 w-24 rounded bg-slate-200 animate-pulse mb-1" />
          ...
          <div className="flex gap-4 border-b border-slate-200 pb-3 mb-4">
            {['Operations', 'Effects', 'Details'].map((tab, i) => (
              <div key={tab} className={`h-4 rounded animate-pulse ${i === 0 ? 'w-20 bg-sky-200' : 'w-16 bg-slate-200'}`} />
            ))}
          </div>
