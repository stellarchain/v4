      ...
      <div className="hidden md:block min-h-screen bg-[var(--bg-primary)]">
        <div className="mx-auto max-w-[1400px] p-6 lg:p-8">
          ...
          <div className="flex gap-4 items-center mb-5">
            ...
            <div className="h-10 w-32 bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-xl animate-pulse" />
          </div>

          {/* Table */}
          <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] shadow-sm overflow-hidden">
            {/* Header */}
            <div className="grid grid-cols-5 gap-4 px-6 py-4 border-b border-[var(--border-subtle)] bg-[var(--bg-primary)]/50">
            ...
            {/* Rows */}
            {[...Array(10)].map((_, i) => (
              <div key={i} className="grid grid-cols-5 gap-4 px-6 py-4 border-b border-[var(--border-subtle)] last:border-b-0 items-center">
                ...
                <div className="h-6 w-24 bg-[var(--info-muted)] rounded-lg animate-pulse" />
            ...
            <div key={i} className="bg-[var(--bg-secondary)] rounded-xl p-4 shadow-sm border border-[var(--border-default)]">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="h-4 w-32 bg-[var(--border-default)] animate-pulse rounded mb-1" />
                    <div className="h-3 w-20 bg-[var(--border-default)] animate-pulse rounded" />
                  </div>
                </div>
                <div className="h-6 w-8 bg-[var(--info-muted)] animate-pulse rounded" />
              </div>
              <div className="flex justify-between items-center">
                <div className="h-5 w-28 bg-[var(--border-default)] animate-pulse rounded" />
