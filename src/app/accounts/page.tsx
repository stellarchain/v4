            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <div className="flex items-center gap-2">
                        <h1 className="text-xl font-semibold text-[var(--text-primary)] tracking-tight">Known Accounts</h1>
                    ...
                    <p className="text-[var(--text-muted)] text-xs">Explore recognized entities, exchanges, and applications on Stellar</p>
                </div>
            </div>
